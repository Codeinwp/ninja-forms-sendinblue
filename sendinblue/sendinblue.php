...
class Mailin
{
    ...
    {
        $called_url = $this->base_url."/".$resource; echo '<br/>';
    ...
    public function get_last_campaigns($total,$type)
    {
             return $this->get("campaign",json_encode(array("total"=>$total,"type"=>$type)));
    }
